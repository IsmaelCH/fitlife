<nav class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-50 transition-colors duration-300">
    <div class="container mx-auto flex justify-between items-center py-4 px-4 sm:px-6 lg:px-8">
        <a href="{{ url('/') }}" class="font-light text-xl tracking-wide text-gray-900 dark:text-white hover:text-gray-700 dark:hover:text-gray-300 transition-colors">FitLife</a>
        <div class="flex items-center space-x-6 text-sm font-light text-gray-600 dark:text-gray-300">
            ...
            @else
                ...
                <a href="{{ route('register') }}" class="bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-5 py-2 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors">Register</a>
            @endauth
            ...
            <button
                ...
                @click="toggle()"
                class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 transition-colors"
            >
